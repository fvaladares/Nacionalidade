 ...
 * Last modified 08/08/2022 18:11
 *
...
package br.pucminas.meunome.data.network

import br.pucminas.meunome.BuildConfig
...
object NationalizeApi {
    val retrofitService: NationalizeApiService by lazy {
        retrofit.create(NationalizeApiService::class.java)
    }
}